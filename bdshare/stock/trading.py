...
def get_current_trade_data(symbol=None, retry_count=3, pause=0.001):
    """
...
def get_dsex_data(symbol=None, retry_count=3, pause=0.001):
    """
...
def get_cse_current_trade_data(symbol=None):
    """
        ...
        :return: dataframe
    """
    r = requests.get(vs.DSE_URL+vs.CSE_LSP_URL)
